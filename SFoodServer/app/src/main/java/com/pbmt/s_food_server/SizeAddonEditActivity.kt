...
import com.pbmt.s_food_server.adapter.MyAddonAdapter
import com.pbmt.s_food_server.adapter.MySizeAdapter
import com.pbmt.s_food_server.common.Common
import com.pbmt.s_food_server.eventbus.*
...
class SizeAddonEditActivity : AppCompatActivity() {
    ...
    private fun saveData() {
        if(foodEditPosition != -1){
            ...
            FirebaseDatabase.getInstance().getReference(Common.CATEGORY_REF).child(Common.categorySelected!!.menu_id!!)
                .updateChildren(updateData)
                .addOnFailureListener {
                    e:Exception->Toast.makeText(this@SizeAddonEditActivity,""+e.message,Toast.LENGTH_SHORT).show()
                }
